<div class="pricing-2">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card card-pricing" data-background="image" style="background-image: url('{{asset('img/sections/daniel-olahh.jpg') }} ')">
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card card-pricing" data-background="image" style="background-image: url('{{asset('img/sections/forest-bg.jpg') }} ')">
            <div class="card-body">
              ...
              <a href="javascript:;" class="btn btn-success btn-round">
                Get Started
              </a>
            </div>
          </div>
        ...
        <div class="col-md-4">
          <div class="card card-pricing" data-background="image" style="background-image: url('{{asset('img/sections/anders-jilden.jpg') }} ')">
            <div class="card-body">
              ...
              <a href="javascript:;" class="btn btn-danger btn-round ">Get Started</a>
            </div>
          </div>
        </div>
      </div>
