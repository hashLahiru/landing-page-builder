        ...
        <div class="col-md-6">
          <div class="card card-plain card-blog text-center">
            <div class="card-image">
              <a href="javascript:;">
                <img class="img img-raised" src="{{ asset('img/sections/val-vesa.jpg') }}" alt="Val Vesa">
            ...
            <div class="card-body">
              ...
              <h3 class="card-title">
                <a href="javascript:;">Learning different cultures through travel</a>
              </h3>
              <p class="card-description">
                A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart. I am alone, and feel the charm of existence in this spot.
              </p>
              <br />
              <a href="javascript:;" class="btn btn-warning btn-round"> Read More</a>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="card card-plain card-blog text-center">
            <div class="card-image">
              <a href="javascript:;">
                <img class="img img-raised" src="{{ asset('img/sections/rodrigo-ardilha.jpg') }}" alt="Rodrigo Ardilha">
            ...
            <div class="card-body">
              ...
              <h3 class="card-title">
                <a href="javascript:;">Kick-Ass ways to disappear like a Ninja!</a>
              </h3>
              <p class="card-description">
              ...
              <br />
              <a href="javascript:;" class="btn btn-primary btn-round"> Read More</a>
            </div>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="card card-plain card-blog text-center">
            <div class="card-image">
              <a href="javascript:;">
                <img class="img img-raised" src="{{ asset('img/sections/federico-beccari.jpg') }}" alt="Federico Beccari">
            ...
            <div class="card-body">
              ...
              <h3 class="card-title">
                <a href="javascript:;">We will breathe clean air and exercise</a>
              </h3>
              <p class="card-description">
              ...
              <br />
              <a href="javascript:;" class="btn btn-danger btn-round"> Read More</a>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="card card-plain card-blog text-center">
            <div class="card-image">
              <a href="javascript:;">
                <img class="img img-raised" src="{{ asset('img/sections/pedro-lastra.jpg') }}" alt="Pedro Lastra">
            ...
            <div class="card-body">
              ...
              <h3 class="card-title">
                <a href="javascript:;">Readers Pick of The Month</a>
              </h3>
              <p class="card-description">
              ...
              <br />
              <a href="javascript:;" class="btn btn-success btn-round"> Read More</a>
            </div>
          </div>
        </div>
      </div>
