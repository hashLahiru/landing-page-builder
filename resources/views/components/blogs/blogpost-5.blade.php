<div class="blog-5">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-5">
          <div class="card" data-background="image" style="background-image: url('{{ asset('img/sections/forest-bg.jpg') }}')"
          >
            <div class="card-body">
              <h6 class="card-category">
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="card" data-background="image" style="background-image: url('{{ asset('img/sections/pavel-kosov.jpg') }}')"
>
            <div class="card-body">
              <h6 class="card-category">
        ...
        <div class="col-md-6">
          ...
          <div class="card" data-background="image" style="background-image: url('{{ asset('img/sections/ilya-yakover.jpg') }}')">
            ...
            <div class="card-body">
              ...
              <div class="card-footer">
                <div class="author">
                  <a href="javascript:;">
                    <img src="{{asset('img/faces/clem-onojeghuo-3.jpg') }}" alt="..." class="avatar img-raised">
        ...
        <div class="col-md-3">    
          <div class="card" data-background="image" style="background-image: url('{{ asset('img/sections/vincent-versluis.jpg') }}')">
            <div class="card-body">
              <h6 class="card-category">
              ...
              <div class="card-footer">
                <div class="author">
                  <a href="javascript:;">
                    <img src="{{ asset('img/faces/ayo-ogunseinde-2.jpg') }}" alt="Ayo Ogunseinde" class="avatar img-raised">
