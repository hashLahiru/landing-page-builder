{{-- <div class="contactus-1 section-image" style="background-image: url('{{ asset('assets/img/sections/soroush-karimi.jpg') }}')"> --}}
                ...
                <div class="card-body">
                  <div class="info info-horizontal">
                    ...
                    <div class="description">
                      <h4 class="text" style="color: black;">Find us at the office</h4>
                      <p class = "text" style="color: black;" > Bld Mihail Kogalniceanu, nr. 8,<br>
                        7652 Bucharest,<br>
                        Romania
                      </p>
                    </div>
                  ...
                  <div class="info info-horizontal">
                    ...
                    <div class="description">
                      <h5 class="text" style="color: black;">Give us a ring</h5>
                        <p class = "text" style="color: black;"  > Michael Jordan<br>
                          +40 762 321 762<br>
                          Mon - Fri, 8:00-22:00
                        </p>
                      </div>
