          ...
          <div class="card card-plain">
            <div class="card-img-top">
              <a href="http://www.creative-tim.com/product/paper-kit">
                <img class="img" src="{{asset('img/sections/opt_pk_thumbnail.jpg') }}" />
              </a>
            </div>
            <div class="card-body">
          ...
          <div class="card card-plain">
            <div class="card-img-top">
              <a href="https://www.creative-tim.com/product/light-bootstrap-dashboard-pro">
                <img class="img" src="{{asset('img/sections/opt_lbd_pro_new_thumbnail.jpg') }}" />
              </a>
            </div>
            <div class="card-body">
          ...
          <div class="card card-plain">
            <div class="card-img-top">
              <a href="https://www.creative-tim.com/product/get-shit-done-pro">
                <img class="img" src= "{{asset('img/sections/opt_gsdk_new_thumbnail.jpg') }}"/>
              </a>
            </div>
            <div class="card-body">
