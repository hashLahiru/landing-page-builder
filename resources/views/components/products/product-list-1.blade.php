<div class="projects-1">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-7">                        
          <div class="card" data-background="image" style="background-image: url('{{ asset('img/sections/gukhwa-jang.jpg') }}')">
            <div class="card-body">
      ...
      <div class="row">
        <div class="col-md-7">
          <div class="card" data-background="image" style="background-image: url('{{ asset('img/sections/joshua-stannard.jpg') }}')">
            <div class="card-body">
              <h6 class="card-category">Productivy Apps</h6>
              <a href="javascript:;">
