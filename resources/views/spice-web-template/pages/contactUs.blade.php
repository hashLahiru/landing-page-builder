    ...
    {{-- <div class="page_wrapper">
        ...
        <div class="main_content">
          <div class="template_contact">
            <div class="container">
              <div
                id="shopify-section-template-contact"
                class="shopify-section section section_template__contact"
              >
                <div class="row">
                  <div class="col-sm-4">
                ...
                <div class="row footer_main">
                  <div class="col-sm-3 footer_block footer_block__2_1">
                    <div class="footer_item footer_item__about">
                      ...
                      <img
                        src="../cdn/shop/files/spiceX_225x125_crop_center8a9c.png?v=1614350789"
                  ...
                  <div class="col-sm-3 footer_block">
                    <div class="footer_item footer_item__links">
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="password-page.html">Password page</a>
                        </li>
