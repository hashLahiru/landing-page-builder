    ...
    (window_width = $(window).width()),
        $(".dropdown-menu a.dropdown-toggle").on("click", function (e) {
            ...
            return (
                ...
                o.parent().hasClass("navbar-nav") ||
                    t
                        .next()
                        .css({ top: t[0].offsetTop, left: o.outerWidth() - 4 }),
                !1
            );
        }),
        ...
        $(".textarea-limited").keyup(function () {
            var e,
                ...
                o = $(this).val().length;
            t <= o
                ? $("#textarea-limited-message").text(
                      " you have reached the limit"
                  )
                : ((e = t - o),
                  $("#textarea-limited-message").text(e + " characters left"));
        }),
        768 <= window_width &&
    ...
    (pk = {
            ...
            $('[data-toggle="video"]').click(function () {
                (id_video = $(this).data("video")),
                    ...
                    video.paused
                        ? (video.play(),
                          $(this).html(
                              '<i class="fa fa-pause"></i> Pause Video'
                          ),
        ...
        initSliders: function () {
            ...
            0 != $("#sliderRegular").length &&
                ((e = document.getElementById("sliderRegular")),
                noUiSlider.create(e, {
                    start: 50,
                    range: { min: 0, max: 100 },
                })),
                0 != $("#sliderDouble").length &&
                    ((t = document.getElementById("sliderDouble")),
                    noUiSlider.create(t, {
                        connect: !0,
                        behaviour: "tap",
                        start: [1e4, 5e5],
    ...
    verticalDots: function () {
        ...
        function o() {
            e.each(function () {
                ...
                var e =
                    $(
                        '#cd-vertical-nav a[href="#' + $this.attr("id") + '"]'
                    ).data("number") - 1;
        ...
        $(function () {
            ...
            function e() {
                $(".add-animation:not(.animated)").each(function () {
                    var e = $(this);
                    e.offset().top < o.scrollTop() + o.height() &&
                        e.addClass("animated");
                }),
